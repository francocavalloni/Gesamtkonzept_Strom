...
from read_input_excel import r_LG, r_PV_F, r_PV_DS, r_PV_DOW, dach_süd, dach_ostwest, fassade_süd, fassade_west, fassade_nord, fassade_ost, Feiertage, r_PV_CP, carport
...
"return date_titles, title, data_S"