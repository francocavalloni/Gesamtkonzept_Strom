...
from read_1 import data_S
from __main__ import WELKW_Sim, r_LKW1, r_LKW2, r_LKW3, elkw1_S, elkw2_S, elkw3_S, welkw1_S, welkw2_S, welkw3_S, Verbrauch, schnellladung
print("Mobilität einlesen")
