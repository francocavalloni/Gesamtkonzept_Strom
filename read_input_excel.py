...
#variabeln
LG_Sim = input_dict.get('LG_Sim', 0)
PV_Sim = input_dict.get('PV_Sim', 0)
ELKW_Sim = input_dict.get('ELKW_Sim', 0)
WELKW_Sim = input_dict.get('WELKW_Sim', 0)
EPKW_Sim = input_dict.get('EPKW_Sim', 0)
SP_Sim = input_dict.get('SP_Sim', 0)
excel = input_dict.get('excel', 0)
plot = input_dict.get('plot', 0)
...
hochtarif = tarife_dict.get('hochtarif', 0) * mwst
niedertarif = tarife_dict.get('niedertarif', 0) * mwst
...
capex_sp_fnct = sp_dict.get('capex_sp_fnct', 0)
